...
_BUILTIN_ENV_TYPES = {"local", "docker", "singularity", "modal", "daytona", "vercel_sandbox", "ssh"}
            ...
            with task_lock:
                ...
                if needs_creation:
                    ...
                    try:
                        ...
                        if env_type in ("docker", "singularity", "modal", "daytona", "vercel_sandbox") or env_type not in _BUILTIN_ENV_TYPES:
                            container_config = {
